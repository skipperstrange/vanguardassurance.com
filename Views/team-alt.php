...
<div class="container py-4">
    <ul class="nav nav-pills sort-source sort-source-style-3 justify-content-center" data-sort-id="team" data-option-key="filter">
        <li class="nav-item active" data-option-value=".board"><a class="nav-link text-1 text-uppercase active" href="#"></a></li>
        <?php
    ...
    <div class="sort-destination-loader sort-destination-loader-showing mt-4 pt-2">
        ...
        <div class="col-12 col-sm-6 col-md-3 isotope-item story"></div>
        <?php
            ...
            <div class="container py-2">
					...
					<div class="row">
                        ...
                        <div class="overflow-hidden">
								<h2 class="text-color-dark font-weight-bold text-5 mb-0 pt-0 mt-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="300"><?= $member['name'] ?></h2>
							</div>
