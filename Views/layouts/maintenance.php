				...
				<div class="container">
					<div class="row mt-5">
						<div class="col text-center">
							<div class="logo">
								<a href="index.html">
									<img width="100" src="<?=IMAGES_URL.'cropped-Vanguard-logo-02-300x81.png'?>" alt="<?= CLIENT_NAME ?>">
								</a>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col">
							<div class="row">
								<div class="col-lg-6 offset-lg-3 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="600">
