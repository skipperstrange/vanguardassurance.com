...
$board = [
    ...
    [
        'title'=>"Board Member",
        'name'=>"Richard Hardy",
        ' description'=>"Mr. Hardy holds an MBA from the University of Cape Town’s Graduate School of Business and a BCom (Actuarial Science) from the University of Stellenbosch.
    ...
    [
        ...
        ' description'=>"Kwame is a financial analyst with over 15 years’ industry experience – 8 of which he spent within the life insurance sector, close to 2 years focused on microinsurance and the rest within the non-life sector.
    ...
    [
        ...
        ' description'=>"Frederick has over 15 years of industry experience spanning Technical Operations, Marketing and Strategy. He joined Vanguard Assurance in 2018 as the Chief Operations Officer and was appointed Chief Executive Officer a year later.
    ...
    [
        ...
        'name'=>"Samuel Awotwe",
        ' description'=>"Samuel is a Chartered Accountant with over 14 years’ experience. His forte is using computerized systems to harmonize and optimize finance, accounting and operational functions. He joined Vanguard Assurance in 2020.
    ...
    [
        ...
        'name'=>"Hamza Alhassan",
        ' description'=>"Until his recent appointment, Hamza was the Acting Financial Controller and Head of Legal Affairs. He joined Vanguard Assurance as a Credit Control Officer and has, through dint of hard work, risen through the ranks to become the Head of Legal, Risk Management and Compliance.
    ...
    [
        'title'=>"Head, MIS",
        'name'=>"Moses Adonoo",
        ' description'=>"Moses’s experience in Database Administration, Networking and Application Development spans over 10 years. He joined Vanguard Assurance in 2005 after working as a Systems Engineer at Masai Computers.
    ...
    [
        ...
        ' description'=>"Prior to joining Vanguard Assurance, Solomon worked with Star Assurance Company Limited. He has over 13 years’ experience in the insurance industry.
    ...
    [
        ...
        'name'=>"David Avor",
        ' description'=>"David oversees the entire Reinsurance function at Vanguard Assurance.
    ...
    [
        ...
        'name'=>"Abeiku Terry",
        ' description'=>"Abeiku joined Vanguard Assurance in 2012 as an underwriter and rose through the ranks to his current position where he leads Vanguard Assurance’s underwriting team.
    ...
    [
        'title'=>"Group Office",
        'name'=>"Doreen Khulor",
        ' description'=>"Doreen joined Vanguard Assurance in 1995 and is currently responsible for managing the Group Office’s administrative functions.
