...
<div class="">
    ...
    <ol>
        ...
        <li>
            <strong>Advance Payment/Mobilization Bond:</strong>
...
<div class="">
    ...
    <p>These are a guarantee to CEPS acting on behalf of the Republic of Ghana, that the insured will pay all duties due on imported/exported goods. Some of these bonds include:</p>
    <ul>
        <li>Security or Warehouse Bond</li>
        <li>Removal Bond </li>
        <li>Temporary Import Bond</li>
        <li>Re-Exportation Bond  </li>
        <li>Transit Bond</li>
        <li>Transshipment Bond</li>
        <li>Exportation Bond</li>
        <li>Customs House Agent General Exportation Bond</li>
    </ul>
</div>