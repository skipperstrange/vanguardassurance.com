									...
									+'<div class="row mb-3" >\n'
										...
										+'<div class="col-lg-7" >\n'
											+'<div class="post-content" >\n'
												+'<h2 class="font-weight-semibold pt-4 pt-lg-0 text-4 line-height-4 mb-2"><a href="'+NEWS_URL+data[i].id+'" >\n'+data[i].title.rendered+'</a></h2 >\n'
									...
									+'<div class="row" >\n'
										+'<div class="col" >\n'
											+'<div class="post-meta text-1" >\n'
												...
												+'<span class="ml-2"> <i class="far fa-user"></i> By <a href="'+`${AUTHOR_NEWS_URL+data[i].author}`+'/articles" >\n'+data[i].x_author+'</a> </span >\n'
												...
												+'<span class="d-block d-sm-inline-block float-sm-right mt-3 mt-sm-0"><a href="'+NEWS_URL+data[i].id+'" class="btn btn-xs btn-light text-1 text-uppercase">Read More</a></span> \n'
											+'</div >\n'
										+'</div >\n'
									+'</div >\n'
								+'</li> \n'
	...
	<div class="col-sm-6 col-md-4 col-lg-4 col-xl-4">
		<article class="post post-medium border-0 pb-0 mb-5">
			...
			<div class="post-content hidden-sm hidden-xs">
				<h2 class="font-weight-semibold text-3 line-height-6 mt-3 mb-2"><a href="${NEWS_URL+data[i].id}">${data[i].title.rendered}</a></h2>
				<!--p>
				...
				<!--div class="post-meta">
					...
					<span class="d-block mt-2"><a href="${NEWS_URL+data[i].id}" class="btn btn-xs btn-light text-1 text-uppercase">Read More</a></span>
				</div-->
			</div>
		</article>
	</div>	`
...
function sideArticleTemplate(data){
	...
	<li>
		...
		<div class="post-info">
			<a href="${NEWS_URL+data[i].id}">${data[i].title.rendered}</a>
			<div class="post-meta">
				<span class="ml-2"> 
  ...
  function postTemplate(data){
	...
	<div class="post-content ml-0">
		...
		<div class="post-meta" id="post-meta">
			<span><i class="far fa-user"></i> By <a href="${AUTHOR_NEWS_URL+data.author}/articles">${data.x_author}</a> </span>
